...
def developer(desarrollador: str):
    """
    Función que filtra el DataFrame df_developer por el desarrollador proporcionado y devuelve una lista de diccionarios con las columnas 'Año', 'Cantidad de Items' y 'Contenido Free'.

    Args:
        desarrollador (str): Nombre del desarrollador a filtrar.

    Returns:
        list: Lista de diccionarios con las columnas 'Año', 'Cantidad de Items' y 'Contenido Free' para el desarrollador especificado.
    """
...
def userdata(user_id: str):
    ...
    Args:
        user_id (str): ID del usuario del cual se desea obtener la información.

    Returns:
        dict: Diccionario con la información del usuario, incluyendo el dinero gastado, el porcentaje de recomendación y la cantidad de items.
    """
    ...
    if user_id not in df_user_reviews["user_id"].values:
        ...
        df_merged = pd.merge(
            df_filtrado[["user_id", "reviews_item_id", "reviews_recommend"]],
